...
import tn.isi.test.soa.config.audit.AuditEventConverter;
import tn.isi.test.soa.domain.PersistentAuditEvent;
...
import static tn.isi.test.soa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
