...
import tn.isi.test.soa.config.Constants;
import tn.isi.test.soa.domain.User;
import tn.isi.test.soa.repository.AuthorityRepository;
import tn.isi.test.soa.repository.UserRepository;
import tn.isi.test.soa.security.AuthoritiesConstants;
import tn.isi.test.soa.service.UserService;
import tn.isi.test.soa.service.dto.PasswordChangeDTO;
import tn.isi.test.soa.service.dto.UserDTO;
import tn.isi.test.soa.web.rest.vm.KeyAndPasswordVM;
import tn.isi.test.soa.web.rest.vm.ManagedUserVM;
...
import static tn.isi.test.soa.web.rest.AccountResourceIT.TEST_USER_LOGIN;
